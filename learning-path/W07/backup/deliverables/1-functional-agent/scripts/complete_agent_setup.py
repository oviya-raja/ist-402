...
# Read system prompt
# Script is in deliverables/1-functional-agent/scripts/, go up one level to get system-prompt.txt
...
# Script is in deliverables/1-functional-agent/scripts/, go up to project root for knowledge-base
